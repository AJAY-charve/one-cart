...
//   return (
//     <div
//       className="w-[100%] min-h-[90vh]  flex
//     items-start flex-col md:flex-row justify-start pt-[70px] overflow-x-hidden z-[2]"
//     >
//       <div
//         className={`md:w-[30vw] lg:w-[20vw] w-[100vw] md:min-h-[100vh] ${
//           showFilter ? "h-[45vh]" : "h-[8vh]"
//         } p-[20px]
//        border-r-[1px] border-gray-400 text-[#aaf5fa] lg:fixed`}
//       >
//         <p
...
//         </div>
//         <div
//           className="lg:w-[80vw] md:w-[60vw] w-[100vw] min-h-[70vh] flex items-center
...
const Collection = () => {
  ...
  // --- UI ---
  return (
    <div className="w-full min-h-[90vh] flex flex-col md:flex-row pt-[80px] bg-gradient-to-b from-slate-900 to-slate-800 text-white">
      {/* FILTER SIDEBAR */}
      <div
