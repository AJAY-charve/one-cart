...
const OurPolicy = () => {
  ...
  flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px]"
    >
      ...
      <div
        className="w-[100%] md:min-h-[50%] h-[20%] flex items-center justify-center flex-wrap
      lg:gap-[50px] gap-[80px]"
      >
        <div
          className="w-[400px] max-w-[90%] h-[60%] flex items-center 
        ...
        >
          ...
          />
          <p
            className="font-semibold md:text-[25px] text-[19px] text-[#a5e8f7]
              text-center"
          >
            Y Days Return Policy
          </p>
          <p
            className="font-semibold md:text-[18px] text-[12px] text-[aliceblue]
              text-center"
          >
        ...
        >
          ...
          <p
            className="font-semibold md:text-[18px] text-[12px] text-[aliceblue]
              text-center"
          >
            Trusted Customer Support - Your Satisfaction Is Our Prority.
          </p>
        </div>
      </div>
    </div>
