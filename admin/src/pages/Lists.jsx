  ...
  text-white"
    >
      ...
      >
        <Sidebar />
        <div
          className="w-[82%] h-[100%] lg:ml-[320px] md:ml-[230px] mt-[70px] flex flex-col
        gap-[30px] overflow-x-hidden py-[50px] ml-[100px]"
        >
          <div
            className="w-[400px] h-[50px] text-[28px] md:text-[40px] mb-[20px]
          text-white"
          >
            All List Products
          </div>
          ...
          {list?.length > 0 ? (
            list.map((item, index) => (
              ...
              items-center justify-start gap-[5px] md:gap-[30px] p-[10px] md:px-[30px]"
                key={index}
              >
                <img
                  src={item.image1}
                ...
                <div className="w-[90%] h-[80%] flex flex-col items-start justify-center gap-[2px]">
                  <div className="w-[100%] md:text-[20px] text-[15px] text-[#befof3]">
                    {item.name}
                  </div>
                ...
                <div className="w-[10%] h-[100%] bg-transparent flex items-center *:justify-center">
                  <span
                    ...
                    className="w-[35px] h-[30%] flex items-center justify-start rounded-md
                  md:hover:bg-red-300 md:hover:text-black cursor-pointer hover:text-red-300"
                  >
                    x
                  </span>
                </div>
